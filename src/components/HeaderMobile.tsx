import Lupa from "./ui/icons/Lupa";

export default function HeaderMobile() {
  return (
    <header className="mx-2 flex w-full flex-col md:hidden">
      <section className="flex w-full justify-between pt-4 md:mx-5">
      ...
      <section className="ml-2 flex items-center justify-start gap-2 py-1">
        <svg
          fill="none"
          height="18"
          viewBox="0 0 30 18"
        ...
        >
          <line stroke="black" strokeLinecap="round" strokeWidth="2" x1="1" x2="29" y1="1" y2="1" />
          <line stroke="black" strokeLinecap="round" strokeWidth="2" x1="1" x2="29" y1="9" y2="9" />
          <line
            stroke="black"
            strokeLinecap="round"
            strokeWidth="2"
